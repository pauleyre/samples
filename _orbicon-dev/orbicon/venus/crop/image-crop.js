	...
	var _crop_base = orbx_site_url +'/orbicon/venus/crop/';
	...
	function crop_createDivElements()
	{
		...
		smallSquare_tl.src = _crop_base + 'small_square.gif';
		...
		smallSquare_tr.src = _crop_base + 'small_square.gif';
		...
		smallSquare_bl.src = _crop_base + 'small_square.gif';
		...
		smallSquare_br.src = _crop_base + 'small_square.gif';
		...
		smallSquare_tc.src = _crop_base + 'small_square.gif';
		...
		smallSquare_bc.src = _crop_base + 'small_square.gif';
		...
		smallSquare_lc.src = _crop_base + 'small_square.gif';
		...
		smallSquare_rc.src = _crop_base + 'small_square.gif';
	...
	function cropScript_executeCrop(buttonObj)
	{
		...
		var handleSuccess = function(o) {
			...
			{
				redirect(orbx_site_url +'/?' + __orbicon_ln + '=orbicon/venus&read=expo/' + o.responseText + '/&tools=crop');
			}
			sh_ind();
		}
		...
		data[1] = 'crop_x=' + $('input_crop_x').value;
		data[2] = 'crop_y=' + $('input_crop_y').value;
		data[3] = 'crop_w=' + $('input_crop_width').value;
		data[4] = 'crop_h=' + $('input_crop_height').value;
		data[5] = 'type=' + $('input_convert_to').options[$('input_convert_to').selectedIndex].value;
		data[6] = 'overwrite=' + overwrite;
		data[7] = 'tools=crop';
	...
	function cropScript_setBasicEvents()
	{
		...
		YAHOO.util.Event.addListener(document.documentElement,"dragstart",crop_cancelEvent);
		YAHOO.util.Event.addListener(document.documentElement,"selectstart",crop_cancelEvent);
		YAHOO.util.Event.addListener(document.documentElement,"mousemove",cropScript_mouseMove);
		YAHOO.util.Event.addListener(document.documentElement,"mouseup",cropScript_stopResizeMove);

		YAHOO.util.Event.addListener(document.getElementById('input_crop_x'),"blur",cropScript_setCropSizeByInput);
		YAHOO.util.Event.addListener(document.getElementById('input_crop_y'),"blur",cropScript_setCropSizeByInput);
		YAHOO.util.Event.addListener(document.getElementById('input_crop_width'),"blur",cropScript_setCropSizeByInput);
		YAHOO.util.Event.addListener(document.getElementById('input_crop_height'),"blur",cropScript_setCropSizeByInput);
		YAHOO.util.Event.addListener(document.getElementById('crop_percent_size'),"blur",cropScript_validatePercent);

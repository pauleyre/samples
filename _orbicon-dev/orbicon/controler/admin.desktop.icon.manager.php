...
*-----------------------------------------------------------------------*/
	...
	if($_REQUEST['action'] == 'add') {
		$orbicon_x->add_desktop_icon($icon_id, $_REQUEST['icon_owner']);
	}
	else if($_REQUEST['action'] == 'remove') {
		$orbicon_x->remove_desktop_icon($icon_id, $_REQUEST['icon_owner']);
	}

	echo $orbicon_x->print_icon_manager($icon_id);
?>
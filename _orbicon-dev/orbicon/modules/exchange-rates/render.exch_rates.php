<?php
	...
	$tooltip2 = _L('archive_exch_tooltip2');
...
<div id="change_graph_container"><span id="change_graph">{$change_graph}</span>
	<a href="javascript:;" onclick="javascript:update_flash($('current_valid_date').value, 'EUR');">EUR/HRK</a> |
	<a href="javascript:;" onclick="javascript:update_flash($('current_valid_date').value, 'USD');">USD/HRK</a> |
	<a href="javascript:;" onclick="javascript:update_flash($('current_valid_date').value, 'GBP');">GBP/HRK</a> |
	<a href="javascript:;" onclick="javascript:update_flash($('current_valid_date').value, 'CHF');">CHF/HRK</a>
</div>

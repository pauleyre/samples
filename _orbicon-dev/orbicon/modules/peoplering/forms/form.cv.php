...
<input type="hidden" name="contact_id" id="contact_id" value="'.$pr_id.'" />
<p>
<input type="submit" name="submit_cv" id="submit_cv" value="'._L('pr-save-cv').'" />
</p>
<fieldset><legend>'._L('pr-cv').'</legend>
	<div class="left">
		<p>
			<label for="name">'._L('pr-cv-title').'</label><br />
			<input type="text" class="txtFld" name="name" id="name" value="'.$name.'" />
		</p>
		<p>
			<label for="pob">'._L('pr-pob').'</label><br />
			<input type="text" class="txtFld" name="pob" id="pob" value="'.$pob.'" />
		</p>
		<p>
			<label for="county">'._L('pr-county').'</label><br />
			<input type="text" class="txtFld" name="county" id="county" value="'.$county.'" />
		</p>
		<p>
			<label for="doe">'._L('pr-doe').'</label><br />
	...
	<p>
		<label for="past_jobs">'._L('pr-past-jobs').'</label><br />
		<textarea id="past_jobs" name="past_jobs">'.$past_jobs.'</textarea>
	</p>
	<p>
		<label for="rest">'._L('pr-extra-desc').'</label><br />
...
<fieldset><legend>'._L('pr-skills').'</legend>
	<div class="left">
		...
		<p>
			...
			<label for="complementary">'._L('pr-complementary').'</label>
		</p>
	</div>
	<div class="left">
		<p>
	...
	<p>
		<label for="achievements">'._L('pr-achievements').'</label><br />

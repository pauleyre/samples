<?php
	...
	function save_gradj_mc()
	{
		if(isset($_POST['submit'])) {
			...
			$form_id = sql_insert('	INSERT INTO '.TABLE_G_MC_OSN.'
			...
			$form_id2 = sql_insert('	INSERT INTO '.TABLE_G_MC_DOD.'
								  (ime_osn, prezime_osn,
								  jmbg_osn,
									vrsta_kartice_osn, ime_dod, prezime_dod,
			...
			new_hpbform(TABLE_G_MC_OSN, $form_id);
			new_hpbform(TABLE_G_MC_DOD, $form_id2);
...
<xdp:xdp xmlns:xdp='http://ns.adobe.com/xdp/'>
	...
	<pdf
		href='".ORBX_SITE_URL."/orbicon/modules/hpb.form/pdf/gradj/mc-osnovni.pdf'
...
<xdp:xdp xmlns:xdp='http://ns.adobe.com/xdp/'>
	...
	<pdf
		href='".ORBX_SITE_URL."/orbicon/modules/hpb.form/pdf/gradj/mc-dodatni.pdf'
		xmlns='http://ns.adobe.com/xdp/pdf/' />
</xdp:xdp>
";
	}

...
<div>
				...
				<p>
				<label for="date_text"><?php echo _L('date'); ?></label><br />
				<input name="date_text" type="text" id="date_text" style="padding: 3px;width:99%" value="<?php echo $my_news['date_text']; ?>" /><br />

...
/**
 * XHR for YUI calendar date filtering
 ...
 */
	...
	require DOC_ROOT.'/orbicon/modules/invest/class/stock.class.php';

	$stock = new Stock(null);
	$month = intval($_REQUEST['month']);
	$year = intval($_REQUEST['year']);
	$fond = intval($_REQUEST['fond']);

	echo $stock->get_daterange($month, $year, $fond);

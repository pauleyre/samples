...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-left: 1em;">
	<tr>
		<td width="75%" height="50" style="padding-left: 1em;"><strong>OBAVIJESTI</strong></td>
		<td style="padding-left: 1em;"><strong>OBJAVA POČ.</strong></td>
		<td><strong>OBJAVA ZAV.</strong></td>
		<td></td>
	</tr>
	<?php
